                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="review-content-section">
                         <form id="add-department" action="/exam/{{$exam->id}}" method="post" class="add-department" novalidate="novalidate">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <select name="subject_id" class="form-control">
                                            ...
                                            @foreach (auth()->user()->subject as $subject)
                                              <option value="{{$subject->id}}"@if($exam->subject_id==$subject->id){{'selected'}}@endif >{{$subject->$name}}   ,{{$subject->studentclass->$name}}</option>
                                            @endforeach
                                        </select>
                                  </div>
                                <div class="row">
