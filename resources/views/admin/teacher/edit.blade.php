                                ...
                                <div class="row">
                                  <div class="col-lg-6">
                                    <div class="form-group ">
                                        ...
                                        <input name="name" type="text" class="form-control" placeholder="@lang('home.teachername')" value="{{$teacher->user->name}}">
                                    </div>
                                  </div>
                                  <div class="col-lg-6">
                                     <div class="form-group">
                                       <label>@lang('home.email')</label>
                                        <input name="email" type="email" class="form-control" placeholder="@lang('home.email')" value="{{$teacher->user->email}}">
                                     </div>
                                  </div>
                                  <div class="col-lg-6">
                                        <div class="form-group">
