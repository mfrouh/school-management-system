                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="">
                                <a class="has-arrow" href="index.html" aria-expanded="false">
                                       <span class="mini-click-non">@lang('home.tables')</span>
                                    </a>
                                <ul class="submenu-angle collapse" aria-expanded="true" style="height: 0px;">
                                    @php
                                      $studentclass=App\studentclass::all();
                                      $name=__('home.nametr');
                                    @endphp
                                    @foreach ($studentclass as $item)
                                      <li style="text-align: center;"><a title="" href="/table/{{$item->id}}"><span class="mini-sub-pro">{{$item->$name}}</span></a></li>
                                    @endforeach
                                </ul>
                         </li>
                        <li>
                            <a title="@lang('home.sub_groups')" href="/studentclass" aria-expanded="false"><span class="mini-click-non"> @lang('home.sub_groups')</span></a>
                        </li>
                        <li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li>
                                            <a title="@lang('home.groups')" href="/group" aria-expanded="false"> @lang('home.groups')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.sub_groups')" href="/studentclass" aria-expanded="false"> @lang('home.sub_groups')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.students')" href="/student" aria-expanded="false"> @lang('home.students')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.teachers')" href="/teacher" aria-expanded="false"> @lang('home.teachers')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.subjects')" href="/subject" aria-expanded="false"> @lang('home.subjects')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.exams')" href="/exam" aria-expanded="false"> @lang('home.exams')</a>
                                        </li>
                                        ...
                                        <li>
                                            <a title="@lang('home.questions')" href="/question" aria-expanded="false"> @lang('home.questions')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.exams')" href="/resultexams" aria-expanded="false"> @lang('home.exams')</a>
                                        </li>
                                        <li>
                                            <a title="@lang('home.exams')" href="/exams" aria-expanded="false"> @lang('home.exams')</a>
                                        </li>
